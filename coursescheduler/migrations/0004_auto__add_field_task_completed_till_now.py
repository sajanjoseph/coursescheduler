...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.completed_till_now'
        db.add_column('coursescheduler_task', 'completed_till_now',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.completed_till_now'
        db.delete_column('coursescheduler_task', 'completed_till_now')
    ...
    models = {
        ...
        'coursescheduler.task': {
            ...
            'submission_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 16, 0, 0)'})
        }
    }
